...
4. `DefaultRegistrationService` generates both X25519 encryption and Ed25519 signing keypairs, then constructs `RegisterRequest` with both public keys and fingerprints.
