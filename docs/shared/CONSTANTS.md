...
- `AttachmentConstants` defines default attachment size/chunk policy, binary attachment header names, and MIME normalization/validation helpers for attachments.
...
- Attachment MIME syntax validation is enforced during validation.
